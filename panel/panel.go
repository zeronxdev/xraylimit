...
import (
	...
	"github.com/AikoPanel/Xray-Server/api"
	"github.com/AikoPanel/Xray-Server/api/aikopanel"
	"github.com/AikoPanel/Xray-Server/api/newV2board"
	"github.com/AikoPanel/Xray-Server/api/v2board"
	"github.com/AikoPanel/Xray-Server/app/mydispatcher"
	_ "github.com/AikoPanel/Xray-Server/cmd/distro/all"
	"github.com/AikoPanel/Xray-Server/service"
	"github.com/AikoPanel/Xray-Server/service/controller"
)
